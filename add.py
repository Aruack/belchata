'''
=============ARUACK=====================
belchata members adding script
GITHUB :- https://github.com/aruack/belchata 
************************************************
'''
...
for a in accounts:
    ...
    clnt = TelegramClient(f'sessions/{phn}', 11188228, '742032cbca22f46111bfaf9532e82a0a')
    clnt.connect()
    banned = []
...
for acc in to_use:
    stop = index + 60
    c = TelegramClient(f'sessions/{acc[0]}', 11188228 , '742032cbca22f46111bfaf9532e82a0a')
