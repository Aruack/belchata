...
/_/   \_\_| \_\\___/_/   \_\____|_|\_\
    ...
    print(f'   Version: 0.1 | Author: ARUACK{n}\n')
...
while True:
    ...
    print(lg+'[4] Update your belchata'+n)
    print(lg+'[5] Quit'+n)
    a = int(input('\nEnter your choice: '))
    if a == 1:
        new_accs = []
        with open('vars.txt', 'ab') as g:
            number_to_add = int(input(f'\n{lg} [~] Enter no. of acc. to add: {r}'))
            ...
            for number in new_accs:
                c = TelegramClient(f'sessions/{number}', 11188228 , '742032cbca22f46111bfaf9532e82a0a')
                c.start(number)
        ...
        if len(accounts) == 0:
            ...
            for account in accounts:
                phone = str(account[0])
                client = TelegramClient(f'sessions/{phone}', 11188228 , '742032cbca22f46111bfaf9532e82a0a')
                client.connect()
        ...
        try:
            # https://raw.githubusercontent.com/ARUACK/belchata/main/version.txt
            version = requests.get('https://raw.githubusercontent.com/ARUACK/belchata/main/version.txt')
        except:
        ...
        if float(version.text) > 1.1:
            ...
            if prompt == 'y' or prompt == 'yes' or prompt == 'Y':
                ...
                os.system('curl -l -O https://raw.githubusercontent.com/ARUACK/belchata/main/add.py')
                os.system('curl -l -O https://raw.githubusercontent.com/ARUACK/belchata/main/manager.py')
            ...
            print(f'{lg}[i] Your belchata is already up to date')
            input('Press enter to goto main menu...')
    elif a == 5:
        clr()
        banner()
